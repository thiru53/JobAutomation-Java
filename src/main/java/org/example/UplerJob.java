...
public class UplerJob {
    ...
    private static void clickOnMainMenuItem(String menuName) {
    ...
    private static void applyFilter(String filterName, String filterValue) {
    ...
    public static void applyToJob(Locator jobItem) throws InterruptedException {
        jobItem.click();
