...
public class LinkedInJobPlayWrightTest extends PlayWriteBaseTest {
    ...
    void linkedJobTest() throws InterruptedException {
        ...
        try {
            ...
            /**
            page.locator("input#username").fill("thirupathaiah.salla@gmail.com");
            logger.info("UserName entered");

            page.locator("input#password").fill("Thiru@linkedin1");
            logger.info("Password entered");
            **/

            page.locator("input#username").fill("tirupathaiah.salla2@gmail.com");
            logger.info("UserName entered");

            page.locator("input#password").fill("Thiru@123");
            logger.info("Password entered");
    ...
    private void applyJobSearchFilter(Map<String, List<String>> filters) throws InterruptedException {
        ...
        while (CollectionUtils.isEmpty(liSearchHdr)) {
            Thread.sleep(1000);
            logger.info("Waiting for Job Search Filters to be visible");
        }
