...
public class UplerJobTest extends BrowserStackRunner {

    private static final Logger logger = LoggerFactory.getLogger(UplerJobTest.class);
    ...
    void uplerJobTest() throws InterruptedException {
        ...
        try {
            ...
            logger.info("Logged in Successfully and page title : {}", title);
            ...
            logger.info("Found {} Jobs",jobCardContainers.size());
            logger.info("Applying Jobs...");
    ...
    private void applyFilter(String filterName, String filterValue) {
        logger.info("\t ==> Filter [ {} : {}]", filterName, filterValue);
